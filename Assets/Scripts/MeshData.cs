...
public class MeshData
{
    ...
    {
        triangles.Add(vertices.Count - 4); // Point 0
        triangles.Add(vertices.Count - 3); // Point 1
        triangles.Add(vertices.Count - 2); // Point 2

        triangles.Add(vertices.Count - 4); // Point 0
        triangles.Add(vertices.Count - 2); // Point 2
        triangles.Add(vertices.Count - 1); // Point 3
